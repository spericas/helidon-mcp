...
final class McpCodegen implements CodegenExtension {
    ...
    private void addToolAnnotationsMethod(Method.Builder builder, Annotation toolAnnotation) {
        builder.name("annotations")
                ...
                .addContent(toolAnnotation.booleanValue("destructiveHint").orElse(false).toString())
                .addContentLine(")")
                ...
                .addContent(toolAnnotation.booleanValue("openWorldHint").orElse(false).toString())
                .addContentLine(");")
                .decreaseContentPadding()
