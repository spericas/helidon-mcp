...
It allows you to create events and view them through a single registered resource.
...
When the MCP Inspector starts, it will automatically open a new browser window. Follow these steps to connect it to your running MCP server:
