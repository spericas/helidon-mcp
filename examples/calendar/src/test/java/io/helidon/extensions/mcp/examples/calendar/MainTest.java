...
class MainTest {
    ...
    static void routing(HttpRouting.Builder builder) {
        ...
        Main.setUpRoute(builder, config);
    }
    ...
    void testResourceList() {
        ...
        assertThat(resource.uri(), is("file://calendar/events"));
    ...
    void testResourceCall() {
        McpSchema.ReadResourceRequest request = new McpSchema.ReadResourceRequest("file://calendar/events");
        ...
        assertThat(content.uri(), is("file://calendar/events"));
    ...
    void testResourceTemplateList() {
        ...
        assertThat(template.description(), is("Resource Template to find calendar events registry"));
    }
